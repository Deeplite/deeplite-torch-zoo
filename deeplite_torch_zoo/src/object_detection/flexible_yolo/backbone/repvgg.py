...
from deeplite_torch_zoo.src.object_detection.flexible_yolo.modules import SEBlock
...
class RepVGG(nn.Module):
    def __init__(
        ...
        self.stage1, _ = self._make_stage(
            int(64 * width_multiplier[0]), num_blocks[0], stride=2
        )
        self.stage2, c3_channel = self._make_stage(
            int(128 * width_multiplier[1]), num_blocks[1], stride=2
        )
        self.stage3, c4_channel = self._make_stage(
            int(256 * width_multiplier[2]), num_blocks[2], stride=2
        )
        self.stage4, c5_channel = self._make_stage(
