...
class RepPANNeck6(nn.Module):
    ...
    def __init__(self, channels_list=None, num_repeats=None, block=RepVGGBlock):
        ...
        self.upsample1 = Transpose(
            in_channels=channels_list[7], out_channels=channels_list[7]  # 256  # 256
        )
        ...
        self.upsample2 = Transpose(
            in_channels=channels_list[8], out_channels=channels_list[8]  # 128  # 128
        )
...
class CSPRepPANNeck(nn.Module):
    ...
    def __init__(
        self, channels_list=None, num_repeats=None, block=BottleRep, csp_e=float(1) / 2
    ):
        super().__init__()
        ...
        self.upsample1 = Transpose(
            in_channels=channels_list[6], out_channels=channels_list[6]  # 128  # 128
        )
