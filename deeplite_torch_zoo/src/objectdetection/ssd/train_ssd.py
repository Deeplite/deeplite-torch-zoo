...
parser.add_argument("--dataset_type", default="custom-coco", type=str,
                    help='Specify dataset type. Currently support coco, voc and open_images.')
...
if __name__ == '__main__':
    ...
    for dataset_path in args.datasets:
        if args.dataset_type == 'voc':
            ...
            train_annotate = os.path.join(dataset_path, "annotations/instances_train2017.json")
            train_coco_root = os.path.join(dataset_path, "train2017")
            dataset = CocoDetectionBoundingBox(train_coco_root, train_annotate,
                transform=train_transform, target_transform=target_transform)
    ...
    if args.dataset_type == "voc":
        ...
        val_annotate = os.path.join(dataset_path, "annotations/instances_val2017.json")
        val_coco_root = os.path.join(dataset_path, "val2017")
        val_dataset = CocoDetectionBoundingBox(val_coco_root, val_annotate,
                transform=train_transform, target_transform=target_transform)

    elif args.dataset_type == 'custom-coco':
        val_annotate = os.path.join(dataset_path, "test_data_COCO.json")
        val_coco_root = os.path.join(dataset_path, "images/test")
        val_dataset = CocoDetectionBoundingBox(val_coco_root, val_annotate,
                transform=train_transform, target_transform=target_transform)
