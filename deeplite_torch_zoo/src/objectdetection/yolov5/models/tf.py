...
"""
# The file is modified by deeplite from the original implementation on Mar 10, 2023
...
from deeplite_torch_zoo.src.objectdetection.yolov5.models.experimental import (
    C3x, DWConvTranspose2d, MixConv2d)
...
from deeplite_torch_zoo.src.objectdetection.yolov5.models.yolov5_6 import (
    C3, SPP, SPPF, Bottleneck, BottleneckCSP, Concat, Conv, CrossConv, DWConv,
    Focus)
...
def parse_model(d, ch, model, imgsz):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [
            ...
            c1, c2 = ch[f], args[0]
            c2 = round_channels(c2 * gw, 8) if c2 != no else c2
