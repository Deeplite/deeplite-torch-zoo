...
from deeplite_torch_zoo.src.poseestimation.datasets.registry import PIPELINES
from deeplite_torch_zoo.src.poseestimation.datasets.post_processing import (
    affine_transform, fliplr_joints, get_affine_transform)
...
class TopDownGenerateTarget:
    ...
    def __init__(
        self, sigma=2, kernel=(11, 11), encoding="MSRA", unbiased_encoding=False
    ):
        self.sigma = sigma
