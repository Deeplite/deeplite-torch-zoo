...
def get_imagenet(data_root, batch_size=128, img_size=224, num_workers=4, fp16=False, distributed=False,
    device="cuda", train_split='imagenet_training', val_split='imagenet_val', **kwargs):
