...
@MODEL_WRAPPER_REGISTRY.register('mlp2','mnist','classification')
...
@MODEL_WRAPPER_REGISTRY.register('mlp4','mnist','classification')
...
@MODEL_WRAPPER_REGISTRY.register('mlp8','mnist','classification')
