...
from deeplite_torch_zoo.src.classification.mobilenets.mobilenetv1 import MobileNetV1, MobileNetV1_96
...
model_urls = {
    ...
    "mobilenetv1_0.25_96px": "http://download.deeplite.ai/zoo/models/mobilenet_v1_0.25_96px_798-8df2181bdab1433e.pt",
}
...
def _mobilenetv1_vww_96(arch, pretrained=False, progress=True, num_classes=2, device='cuda', width_mult=0.25):
    model = MobileNetV1_96(num_classes=num_classes, width_mult=width_mult)
...
def mobilenet_v1_025_96px_vww(pretrained=False, progress=True, num_classes=2, device='cuda',width_mult=0.25):
    return _mobilenetv1_vww_96("mobilenetv1_0.25_96px", pretrained=pretrained, progress=progress, num_classes=num_classes, device=device, width_mult=width_mult)