...
from deeplite_torch_zoo.src.objectdetection.eval.voc.voc_evaluator import yolo_voc07_eval
from deeplite_torch_zoo.wrappers.eval import mb2_ssd_coco_eval_func

classification_eval_list = [classification_eval]

objectdetection_eval_list = [rcnn_eval_coco,
                            mb1_ssd_eval_func,
...
class TestEvalFunction(unittest.TestCase):
    ...
    def test_eval_classification(self):
        all_classification_models = list_models(task_type_filter='classification', 
                                    print_table=False, 
                                    return_list=True)
    ...
    def test_eval_segmentation(self):
        all_segmentation_models = list_models(task_type_filter='semantic_segmentation', 
                            print_table=False, 
                            return_list=True)
