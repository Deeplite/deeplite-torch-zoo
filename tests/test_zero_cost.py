...
def test_zero_cost_metrics_dataloader(metric_name, ref_value, cifar100_dataloaders, rel_tolerance=0.01):
    init_seeds(42)
...
def test_zero_cost_metrics_generator(metric_name, ref_value, cifar100_dataloaders, rel_tolerance=0.01):
    init_seeds(42)
    model = get_model(model_name='resnet18', dataset_name='cifar100', pretrained=False)
