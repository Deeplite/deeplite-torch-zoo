...
Modified from timm commit d4ea5c7d7d5 to replicate the setup of https://github.com/Alibaba-MIIL/Solving_ImageNet
"""
...
from timm.models import (convert_splitbn_model, convert_sync_batchnorm,
                         load_checkpoint, model_parameters, resume_checkpoint,
                         safe_model_name, set_fast_norm)
...
group.add_argument('--crop-pct', default=0.95, type=float,
...
group.add_argument('--use-ml-decoder-head', type=int, default=0)
...
group.add_argument('--weight-decay', type=float, default=2e-2,
...
group.add_argument('--lr', type=float, default=2e-3, metavar='LR',
...
group.add_argument('--aa', type=str, default='rand-m7-mstd0.5-inc1', metavar='NAME',
...
group.add_argument('--model-ema', type=int, default=1,
                    help='Enable tracking moving average of model weights')
group.add_argument('--model-ema-force-cpu', action='store_true', default=False,
                    help='Force ema to be tracked on CPU, rank=0 node only. Disables EMA validation.')
group.add_argument('--model-ema-decay', type=float, default=0.99996,
...
group.add_argument('--amp', type=int, default=1,
